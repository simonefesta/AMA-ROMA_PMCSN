...
//        EventListEntry event= eventHandler.getInternalEventsOfficina().get(0);
    ...
    public void baseSimulation() throws Exception {
            ...
            System.out.println("num "+internalEventsOfficina.size());
            //while(eventHandler.getInternalEventsOfficina().size()>0 || this.number>0){
            ...
            //System.out.println("size "+internalEventsOfficina.size());
            ...
            if(e==0){ // controllo se l'evento è un arrivo
                ...
                /*if(eventList.get(0).getT()>STOP && this.number==0){
                    ...
                    this.eventHandler.setEventsOfficina(eventList);
                }*/
                ...
                if(this.number>=SERVERS_OFFICINA[this.id]){ //controllo se ci sono altri eventi da gestire
                    ...
                    //this.rnd.decrementVehicle(queueOfficina.get(0).getVehicleType());
        ...
        public void printStats() {
            ...
            //System.out.println("  avg interarrivals .. = " + this.eventHandler.getEventsOfficina().get(0).getT() / this.jobServed);
